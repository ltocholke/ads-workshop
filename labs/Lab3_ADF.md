...
#### 1.	Navigate to Azure Data Factory in the Azure portal
   ...
   ![](/screenshots/Lab3/ADF01_Navigate.png)
   
#### 2.	Create a Copy data pipeline
 
  ![](/screenshots/Lab3/ADF02_CreateCopyPipeline.png)
...
#### 3.	Enter Properties for copying data from blob storage to Azure Data Lake Store
  ...
  ![](/screenshots/Lab3/ADF03_CopyPipelineProperties.png)
  
#### 4.	Add an Azure Blob Storage account as a source

![](/screenshots/Lab3/ADF04_CopyPipelineSelectSource.png)
...
#### 5.	Configure Blob Storage account connection settings and click Next
  ...
  4. **Storage Account Name:** sasdswkshpdatastorage
   ...
   ![](/screenshots/Lab3/ADF05_CopyPipelineSelectSA.png)
 
#### 6.	Select CSV file from Blob Storage

![](/screenshots/Lab3/ADF06_CopyPipelineSelectSACsv.png)

![](/screenshots/Lab3/ADF07_CopyPipelineSelectSACsv2.png)
...
#### 7.	Configure properties of CSV file for import and click Next
  ...
  5. **Make sure both checkboxes under the Skip line count option are checked**
   ...
   ![](/screenshots/Lab3/ADF08_CopyPipelineFileFormat.png)
   
   ![](/screenshots/Lab3/ADF08_02CopyPipelineFileFormat.png)
   

#### 8. Add an Azure Data Lake Storage account as a destination

![](/screenshots/Lab3/ADF09_CopyPipelineSelectDestination.png)
...
![](/screenshots/Lab3/ADF10_CopyPipelineDestinationConnection.png)
 
#### 10. Select output file and folder in Azure Data Lake Store

![](/screenshots/Lab3/ADF11_CopyPipelineDestinationSelectFile.png)
...
![](/screenshots/Lab3/ADF12_CopyPipelineDestinationFileFormat.png)
  
#### 12. Accept defaults for performance and click Next

![](/screenshots/Lab3/ADF13_CopyPipelinePerfSettings.png)
 
#### 13. Click “Authorize” and enter your Azure credentials

![](/screenshots/Lab3/ADF14_CopyPipelineSummary.png)

#### 14. After you see a green check mark by “Authorize” click Next

![](/screenshots/Lab3/ADF15_CopyPipelineSummaryAuthorize.png)
 
#### 15. Once your pipeline has been deployed, click the link to view it

![](/screenshots/Lab3/ADF16_CopyPipelineComplete.png)
 
#### 16. Navigate to the Pipeline json in the Azure portal.

![](/screenshots/Lab3/ADF32_ModifyPipeline.png)
 
#### 17. Change data types on columns in CSV file

![](/screenshots/Lab3/ADF17_ChangeCSVColumnType1.png)

![](/screenshots/Lab3/ADF18_ChangeCSVColumnType2.png)
  
#### 18. Deploy the pipeline

![](/screenshots/Lab3/ADF33_DeployPipeline.png)
...
![](/screenshots/Lab3/ADF19_CopyPipelineProps2.png)
 
#### 2.	Select Azure SQL DB as a source and click Next

![](/screenshots/Lab3/ADF20_CopyPipelineSelectSourceSQLDB.png)
...
![](/screenshots/Lab3/ADF21_CopyPipelineSQLDBConnection.png)
...
#### 1.	Navigate to the Azure Data Factory in the Azure portal
 ![](/screenshots/Lab3/ADF31_NavigateToADF.png)
 ![](/screenshots/Lab3/ADF32_ModifyPipeline.png)
#### 2.	Clone the current Copy-AzureSQLDB2ADLS pipeline.
 ![](/screenshots/Lab3/ADF33_1ClonePipeline.png)
#### 3.	Copy and paste the Copy-AzureSQLDB2ADLS.json file into the Pipeline editor. 
 ...
 ![](/screenshots/Lab3/ADF33_2_CopyPastePipeline.png)
  2. Change the hubName property to be the name of your Azure Data Factory
 ![](/screenshots/Lab3/ADF33_3_ChangeHubName.png)
#### 4.	Click “Deploy”
 ![](/screenshots/Lab3/ADF33_DeployPipeline.png)
#### 5.	Navigate to the “Data Explorer” for Azure Data Lake Storage to verify the files have been copied
 ![](/screenshots/Lab3/ADF34_NavigateToADLS.png)
 
 ![](/screenshots/Lab3/ADF35_DataExplorer.png)
 
 ![](/screenshots/Lab3/ADF36_ViewDataExplorer.png)
